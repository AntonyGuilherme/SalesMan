...
class PSO:
    ...
    def run(self):
        ...
        for t in range(self.iterations):
            ...
            print(f"cost is {self.gbest.pbest_cost}")
...
if __name__ == "__main__":
    cities = read_cities()
    pso = PSO(iterations=1200, population_size=200, pbest_probability=0.4, gbest_probability=0.10, cities=cities)
    pso.run()
    ...
    y_list.append(pso.gbest.pbest[0].y)
    fig = plt.figure(1)
    fig.suptitle('Enxame de Particulas')
